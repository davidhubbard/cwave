...
typedef int (* mio_timeout_fn)(void * data1, void * data2);
...
typedef struct mio_st
{
  ...
  void * (*mio_add_immed_timeout)(struct mio_st **m, mio_timeout_fn fn, void * data1, void * data2);

  void (*mio_cancel_immed_timeout)(struct mio_st **m, void * t);

  void * (*mio_add_timeout)(struct mio_st **m, mio_timeout_fn fn, void * data1, void * data2, unsigned long long msec);

  void (*mio_cancel_timeout)(struct mio_st **m, void * t);

  void (*mio_run_timeout_early)(struct mio_st **m, void * t);
} **mio_t;
...
/** an 'immed' timeout will fire before any fd is checked, at the top of the next mio_run() call */
/** these are needed mainly for cleanup operations that can't run while xhash_iters are being walked */
/** to do 'idle processing,' call mio_add_timeout(msec == 0) to run at the next mio_run() call but check fds too */
#define mio_add_immed_timeout(m, fn, data1, data2) ((*m)->mio_add_immed_timeout((m), (fn), (data1), (data2)))

#define mio_cancel_immed_timeout(m, t) (*m)->mio_cancel_immed_timeout((m), (t))

#define mio_add_timeout(m, fn, data1, data2, msec) ((*m)->mio_add_timeout((m), (fn), (data1), (data2), (msec)))

#define mio_cancel_timeout(m, t) (*m)->mio_cancel_timeout((m), (t))

#define mio_run_timeout_early(m, t) (*m)->mio_run_timeout_early((m), (t))
