...
static void _roster_get_walker(const char *id, int id_len, void *val, void *arg)
{
    item_t item = (item_t) val;
...
static void _roster_update_walker(const char *id, int id_len, void *val, void *arg)
{
    pkt_t push;
    char *buf;
    int elem, ns;
...
static void _roster_set_item(pkt_t pkt, int elem, sess_t sess, mod_instance_t mi)
{
    ...
    if(nad_find_attr(pkt->nad, elem, -1, "subscription", "remove") >= 0)
    {
        ...
        if(item != NULL)
        {
            ...
            _roster_freeuser_walker(NULL, 0, (void *) item, NULL);
                ...
                if(os_object_get_str(os, o, "jid", &str)) {
                    ...
                    if(item->jid == NULL) {
                        ...
                        if(olditem) {
                            ...
                            _roster_freeuser_walker(NULL, 0, (void *) olditem, NULL);
                        }
